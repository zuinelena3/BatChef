...
#' @export
#' @rdname BatChefParams
setClass("LimmaParams", contains = "BatChefParams",
         slots = c(assay_type = "character", extra = "list"))

#' @export
#' @rdname BatChefParams
setClass("CombatParams", contains = "BatChefParams",
         slots = c(assay_type = "character", extra = "list"))
...
#' @export
#' @rdname BatChefParams
setClass("ScanoramaParams", contains = "BatChefParams",
         slots = c(assay_type = "ANY",
...
#' @export
#' @rdname BatChefParams
setClass("ScMerge2Params", contains = "BatChefParams",
         slots = c(assay_type = "character", extra = "list"))

#' @export
#' @rdname BatChefParams
setClass("BBKNNParams", contains = "BatChefParams",
