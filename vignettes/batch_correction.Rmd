...
To demonstrate, we simulate a dataset with 8,000 genes, 8,000 cells, 
...
```{r}
sce <- simulated_data(nGenes = 8000, batchCells = c(4800, 3200), 
                      group.prob = c(0.4, 0.6), n_hvgs = 2000, 
                      ncomp = 10, seed = 3)
sce
```
